...
public class WebServer {
  ...
  private static PlayerLobby playerLobby = new PlayerLobby();
  ...
  public void initialize() {
    ...
    get(HOME_URL, new GetHomeRoute(templateEngine, playerLobby, games));
    ...
    post(GAME_URL, new PostPlayRoute(templateEngine, playerLobby, games));
    post(RESIGN_URL, new PostResignGameRoute(playerLobby));
